...
info "########################################"
info "Custom Nodes Installation"
info "########################################"

cd /default-comfyui-bundle/ComfyUI/custom_nodes || {
    error "Failed to change directory to ComfyUI custom_nodes for cloning"
    exit 1
}
...
# 3DMax
gcs https://github.com/lrzjason/ComfyUI-EditUtils.git
...
success "Node repositories cloned successfully."